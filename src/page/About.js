                            ...
                            <div class="mt-8 space-y-8 md:-mx-4 md:flex md:items-center md:justify-center md:space-y-0 xl:mt-0">
                                ...
                                <div class="mx-auto max-w-sm rounded-lg border dark:border-gray-700 md:mx-4">
                                    <div class="p-6">
                                        ...
                                        <h2 class="mt-4 text-2xl font-medium text-gray-700 dark:text-gray-300 sm:text-4xl">$50.00 <span class="text-base font-medium">/à vie</span></h2>

                                        <p class="mt-1 text-gray-500 dark:text-gray-300">Paiement unique</p>
