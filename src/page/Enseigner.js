                        ...
                        <div class="mx-auto mt-16 flex max-w-6xl items-start">
                            ...
                            <div>
                                ...
                                <div class="flex flex-row  justify-center">
                                    ...
                                    <div class="mt-8 ml-8 flex flex-col items-center justify-center">
                                        <img class="h-14 w-14 rounded-full object-cover" src={zakaria} />
                                        <div class="mt-4 text-center">
                                            <h1 class="font-semibold text-gray-800 dark:text-white">Zakaria</h1>
                                            <span class="text-sm text-gray-500 dark:text-gray-400">Amellal</span>
                                        </div>
                                    </div>
