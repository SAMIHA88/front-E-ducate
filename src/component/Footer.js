...
font-family: 'Titillium Web', sans-serif;
    ...
    <div class="container mx-auto px-6 py-12">
        ...
        <div>
            ...
            <div class="mt-5 flex flex-col items-start space-y-2">
            <p  class="text-gray-600 transition-colors duration-300  dark:text-gray-300 ">+212 768 768 3768</p>
            <p  class="text-gray-600 transition-colors duration-300  dark:text-gray-300 ">e-ducate@datech.com</p>
            </div>
        </div>
        </div>
